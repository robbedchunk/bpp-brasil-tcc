...
`Co-Authored-By` trailers in the Git history. This development tooling is
unrelated to the system's runtime agent (the Codex SDK explorer), which
remains governed by the trusted validation gate.
